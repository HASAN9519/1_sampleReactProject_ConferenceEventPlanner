...
export const avSlice = createSlice({
  ...
  initialState: [
    ...
    reducers: {
      // incrementAvQuantity() reducer function increments the quantity of a specific item in the state. It takes two parameters: state and action. The action.payload object contains the identifier of the item to increment. The reducer retrieves the item from the state using state[action.payload].If the item exists, it increments its quantity property by 1
      ...
      // decrementAvQuantity() reducer function decrements the quantity of a specific item in the state. Similar to incrementAvQuantity(), it takes two parameters: state and action. The action.payload object contains the item identifier to decrement. - It's reducer retrieves the item from the state using state[action.payload]. If the item exists and its quantity is greater than 0, it decrements its quantity property by 1, ensuring the quantity doesn't drop below 0 and indicates no more available items.
